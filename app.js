...
const getWeather = async () => {
    ...
    try {
        const cityName = document.getElementById('search-bar-input').value || 'tehran';    
        const weatherDataFetch = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=d8ad26653a5f5e9c5fdaa43b80e89601`, {
            headers: {
